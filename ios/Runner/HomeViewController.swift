...
class HomeViewController: UIViewController, UIWebViewDelegate, MattermostApiProtocol, UIGestureRecognizerDelegate  {
    ...
    override func viewDidLoad() {
       ...
       // NotificationCenter.default.addObserver(self, selector:#selector(HomeViewController.keyboardWillAppear(_:)), name: NSNotification.Name.UIResponder.keyboardWillShowNotification, object: nil)
       // NotificationCenter.default.addObserver(self, selector:#selector(HomeViewController.keyboardWillDisappear(_:)), name: NSNotification.Name.UIResponder.keyboardWillHideNotification, object: nil)
...
//        }
    ...
    func webView(_ webView: UIWebView, didFailLoadWithError error: Error) {
        ...
        let refreshAlert = UIAlertController(title: "Loading Error", message: "You may be offline or the Mattermost server you're trying to connect to is experiencing problems.", preferredStyle: UIAlertController.Style.alert)
